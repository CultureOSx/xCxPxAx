...
import Animated, { FadeInDown, FadeInRight, FadeOutLeft, FadeInUp } from 'react-native-reanimated';
...
export default function CultureMatchScreen() {
  ...
  return (
    <View style={[s.container, { backgroundColor: colors.background }]}>
      ...
      >
        <Animated.View entering={FadeInUp.springify().damping(16).duration(600)} style={[s.formContainer, isDesktop && s.formContainerDesktop]}>
          {/* Glass Background */}
          <View
            style={[
                    ...
                    return (
                      <Pressable
                        ...
                        style={({ pressed }) => [
                          s.natChip,
                          {
                            borderColor: isSelected ? CultureTokens.gold : colors.borderLight,
                            backgroundColor: isSelected ? `${CultureTokens.gold}33` : colors.overlay,
                          },
                      ...
                      >
                        ...
                        <Text style={[s.natLabel, { color: colors.textInverse }]} numberOfLines={1}>
                          {nat.label}
                        </Text>
...
const s = StyleSheet.create({
  ...
  selectedLangChip: {
    ...
    backgroundColor: `${CultureTokens.gold}26`,
    borderRadius: Spacing.lg,
    paddingHorizontal: 14,
