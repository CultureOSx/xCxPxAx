...
const s = StyleSheet.create({
  ...
  actionsRow:  { gap: 10 },
  actionBtn:   { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 10 },
  actionBtnText:{ ...TextStyles.chip },
