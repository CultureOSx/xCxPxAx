...
<<<<<<< HEAD
  ...
  filterKey:  { ...TextStyles.tabLabel, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
...
<<<<<<< HEAD
  ...
  filterLabel:      { ...TextStyles.tabLabel, textTransform: 'uppercase', letterSpacing: 0.8 },
