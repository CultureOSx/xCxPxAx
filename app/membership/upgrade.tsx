...
const getStyles = (colors: ReturnType<typeof useColors>) => StyleSheet.create({
  ...
  toggleActive:       { backgroundColor: colors.surface, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 2 },
  ...
  saveBadgeText:      { fontSize: 10, fontFamily: 'Poppins_700Bold', color: '#FFFFFF' },
  priceCard:          { alignItems: 'center', paddingVertical: 32, borderRadius: 24, borderWidth: 1, borderColor: colors.borderLight, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 20, elevation: 5 },
  ...
  highlightCard:      { borderRadius: 20, padding: 20, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderLight, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 10, elevation: 2 },
